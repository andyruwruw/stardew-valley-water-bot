...
namespace WaterBot.Framework
{
    ...
    class Map
    {
            ...
            for (int i = 0; i < nodes; i++)
            {
                ...
                for (int j = 0; j < nodes; j++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Point start = new Point((int)Game1.player.Tile.X, (int)Game1.player.Tile.Y);
        ...
        public List<ActionableTile> findFillPath(Group group, console console)
        {
            ...
            stack.Add(group.findClosestTile((int)Game1.player.Tile.X, (int)Game1.player.Tile.Y).Item1);
